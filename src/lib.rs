...
pub const PHASE1_MOVES: [Move; PHASE1_MOVE_COUNT] = [
...
pub struct SolveStats {
    pub phase1_depth: Option<usize>,
    pub phase1_solutions: usize,
    pub phase1_nodes: u64,
    pub phase1_pruned: u64,
    pub phase1_elapsed: Duration,
    pub phase2_attempts: usize,
    pub phase2_nodes: u64,
    pub phase2_elapsed: Duration,
